...
이 프로젝트는 **HTML, CSS, JavaScript**를 활용하여 실무에 가까운 웹 개발 경험을 쌓기 위한 3주간의 협업 프로젝트입니다. 개인과 팀의 **목표 설정**이 프로젝트 시작 전에 이루어져야 하며, 프로젝트의 과정에서 **트러블 슈팅**과 **발표**까지 포함됩니다. 이 과정은 파이널 프로젝트의 예행 연습이자 팀 단합을 도모하는 기회입니다.

**합리적인 목표 설정**이 중요한 이유는, 실현 가능성과 도전적 요소를 구분하여 **해낼 수 있는 것**에 집중하는 것이 성공적인 프로젝트로 이어지기 때문입니다. 이 프로젝트는 결과뿐만 아니라 **성장 과정**에 중점을 두고 있으며, 이슈 해결과 **문서화 및 기록**의 중요성을 강조합니다.
...
6. 문제 해결 후에는 **정리**하여 이해하기 쉽게 문서화합니다.
